...
//define( 'HEADER_IMAGE_WIDTH', apply_filters( 'twentyten_header_image_width', 1920 ) );
//define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 1080 ) );
...
function twentythirteen_scripts_styles() {
	...
	if ( is_active_sidebar( 'sidebar-agenda' ) )
		wp_enqueue_script( 'jquery-moveWidget' );
